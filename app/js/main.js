$(function () {
  ...
  $('.catalog-btn').on('click', function () {
    $('.catalog-bgmenu').toggleClass('catalog-bgmenu--active');
    $('.burger-overlay').toggleClass('burger-overlay--active');
  });

  $('.burger-overlay, .close, .menu__item, catalog-bgmenu__close, catalog-category__menu-item').on('click', function () {
